...
<section class="about-section text-center" id="about">
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8">
                <h2 class="text-white mb-4">ABOUT US PAGE</h2>
                <p class="text-white-50">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet at consectetur culpa deleniti dicta doloremque earum exercitationem facilis, fugit incidunt minus molestias, necessitatibus odio quisquam quod vel, vero vitae voluptatem?
                </p>
            </div>
        </div>
...
<section class="contact-section bg-black">
    <div class="container px-4 px-lg-5">
        <h1 style="color: white; text-align: center; margin-bottom: 125px; font-size: large">CONTACT US</h1>
<!--        <div>CONTACT</div>-->
        <div class="row gx-4 gx-lg-5">
